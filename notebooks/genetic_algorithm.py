...
def main():
    ...
    for gen in range(1, NGEN + 1):
        ...
        utilitarian_weight, deontological_weight, self_interest_weight = normalized_weights
        Gen_results.append((gen, top.fitness.values[0], utilitarian_weight, deontological_weight, self_interest_weight))
