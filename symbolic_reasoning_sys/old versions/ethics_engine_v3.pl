...
%
% == SUMMARY ==
% - Broadens the scope of the scenario coverage to allow for new
% outcomes
% - This should mean there is always feedback for the GA
% - Added dynamic moral system selection in the make decision
% justification
