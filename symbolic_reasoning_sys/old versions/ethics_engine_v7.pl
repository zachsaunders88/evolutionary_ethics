...
deontological_rule(scenario(dropped_wallet, true, true, many_people_around), return_wallet).
deontological_rule(scenario(dropped_wallet, true, true, isolated_area), return_wallet).
deontological_rule(scenario(dropped_wallet, false, true, many_people_around), hand_to_authority).
...
self_interest_rule(scenario(dropped_wallet, false, true, many_people_around), hand_to_authority).
self_interest_rule(scenario(dropped_wallet, true, false, isolated_area), ignore_wallet).
self_interest_rule(scenario(dropped_wallet, true, false, many_people_around), ignore_wallet).
